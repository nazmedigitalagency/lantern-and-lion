        ...
        <div className="profile-header-content">
          ...
          <div className="profile-header-details">
            ...
            <div className="profile-meta-row">
              ...
              <span>📞 {formPhone}</span>
              <span>•</span>
              <span className="active-dot-text"><span className="active-dot" /> Active Member</span>
            </div>
          </div>
              ...
              return (
                <div key={ch.id} className="profile-child-card">
                  ...
                  <div className="profile-child-details">
                    ...
                    <div className="profile-child-stat">
                      ...
                      <div className="profile-pin-display">
                        <code>{ch.pin ? '•••• ' + ch.pin.slice(-2) : '••••'}</code>
                        <button
                          type="button"
                  ...
                  <div className="profile-child-actions">
                    <button
                      type="button"
                      className="profile-child-action-btn secondary"
                      onClick={() => {
                        setEditChildPinOpen(ch);
                        setNewPin(ch.pin || '');
                        setConfirmPin(ch.pin || '');
          ...
          <div className="profile-card full-width">
            <div className="profile-security-highlight">
              ...
              <div className="profile-security-text">
                ...
                <p>Protect your parent dashboard and child access privileges with an extra verification step.</p>
              </div>
            ...
            <div className="profile-data-grid single-col">
              <div className="profile-session-item">
                <div>
                  ...
                  <small>Active session in Nigeria · Last active just now</small>
                </div>
        ...
        <div className="profile-modal-backdrop" role="dialog" aria-modal="true">
          <div className="profile-modal-box">
            <div className="profile-modal-head">
              ...
              <button type="button" onClick={() => setEditChildPinOpen(null)} className="profile-modal-close">✕</button>
            </div>
            <form onSubmit={handleSaveChildPin} className="profile-modal-form">
              ...
              {pinError && <div className="profile-form-error">{pinError}</div>}

              <label>
                New 4-Digit PIN or Password
                <input
                  type="password"
                  maxLength={12}
                  required
        ...
        <div className="profile-modal-backdrop" role="dialog" aria-modal="true">
          <div className="profile-modal-box">
            <div className="profile-modal-head">
              ...
              <button type="button" onClick={() => setAddChildOpen(false)} className="profile-modal-close">✕</button>
            </div>
            <form onSubmit={handleAddChildSubmit} className="profile-modal-form">
              <p className="profile-modal-help">
              ...
              {childError && <div className="profile-form-error">{childError}</div>}
        ...
        <div className="profile-modal-backdrop" role="dialog" aria-modal="true">
          <div className="profile-modal-box">
            <div className="profile-modal-head">
              ...
              <button type="button" onClick={() => setRemoveConfirmChild(null)} className="profile-modal-close">✕</button>
            </div>
