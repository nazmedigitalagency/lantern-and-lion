...
export default function FamilySetupPage() {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      // Parsed outside the main try/catch below: if this throws (e.g.
      // corrupted localStorage) it must still redirect, not be swallowed
      // into rendering the page as if a session were present.
